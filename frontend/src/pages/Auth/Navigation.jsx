...
const Navigation = () => {
    ...
    return <div style={{ zIndex: 999 }}
        className={`${showSidebar ? "hidden" : 'flex'} xl:flex lg:flex md:hidden sm:hidden flex-col justify-center
    ...
    >
        <div className='flex flex-col justify-center space-y-4'>
         ...
         transform hover:translate-x-2'>
            ...
            <Link to='/favorite' className='flex items-center transition-transform
         transform hover:translate-x-2'>
